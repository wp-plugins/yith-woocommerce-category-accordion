    ...
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( __('Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce category Accordion%2$s to benefit from all features!','ywcca'),'<span class="highlight">','</span>' );?>
                </p>
                <a href="<?php echo $this->get_premium_landing_uri() ?>" target="_blank" class="premium-cta-button button btn">
                    <span class="highlight"><?php _e('UPGRADE','ywcca');?></span>
                    <span><?php _e('to the premium version','ywcca');?></span>
                </a>
            </div>
        </div>
    </div>
    <div class="one section section-even clear">
        <h1><?php _e('Premium Features','ywcca');?></h1>
        <div class="landing-container">
            <div class="col-1">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Category and sublevels','ywcca');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Tag and menu','ywcca');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('Not only categories: with the premium version of the plugin you can display in accordion all the %1$smenus%2$s of your site, in addition to the complete list of all %1$stags%2$s you have linked to the products of your shop. ', 'ywcca'), '<b>', '</b>');?>
                </p>
            </div>
            <div class="col-1">
    ...
    <div class="three section section-even clear">
        <div class="landing-container">
            ...
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf(__('Four different configurable styles that you can assign to the plugin\'s widgets and shortcodes. %1$sDon\'t touch the code and get your result directly from the panel%2$s', 'ywcca'), '<b>', '</b>','<br>');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Shortcode','ywcca');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('Same widget features, same options, but much more freedom: %1$sadd your accordions%2$s everywhere with the shortcode. ', 'ywcca'), '<b>', '</b>');?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Sorting','ywcca');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('A good management of the category list must give the freedom to choose the sorting system to show the category in the page.%3$sThree different options: by %1$sID, name%2$s or %1$snumber%2$s of assigned elements','ywcca'),'<b>','</b>','<br>'); ?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Pages and posts','ywcca');?></h2>
                </div>
                <p>
